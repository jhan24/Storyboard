 ...
 *
 * The MoveXEvent class extends the MoveEvent class
 ...
 * @version 1.00
 */
public class MoveXEvent extends MoveEvent {

    public MoveXEvent(int easing, int startTime, int endTime,
                     int startX, int endX) {
        this.easing = easing;
    ...
    public String toString() {
        return " MX," + easing + "," + startTime + "," + endTime +
                "," + startX + ","  + endX;
    }
}
